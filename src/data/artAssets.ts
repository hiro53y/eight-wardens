...
export const unitArtByUnitId: Record<string, UnitArt> = {
  ...
  'unit-4': unitArtByKey.iris,
  'unit-5': unitArtByKey.kai,
...
export const unitArtByClassId: Record<string, UnitArt> = {
  ...
  sniper: unitArtByKey.ryuka,
  forestArcher: unitArtByKey.ryuka,
  shieldSoldier: unitArtByKey.minato,
  heavyKnight: unitArtByKey.minato,
  holyShieldKnight: unitArtByKey.minato,
  priest: unitArtByKey.iris,
  cleric: unitArtByKey.iris,
  saintess: unitArtByKey.iris,
  ninja: unitArtByKey.kai,
  shadowNinja: unitArtByKey.kai,
  assassin: unitArtByKey.kai,
  hexBreaker: unitArtByKey.glen,
  mage: unitArtByKey.glen,
  archmage: unitArtByKey.glen,
  lancer: unitArtByKey.shino,
  lanceKnight: unitArtByKey.shino,
  lanceSaint: unitArtByKey.shino,
};
